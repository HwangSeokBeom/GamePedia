...
extension Endpoint {
    ...
    static func aiGameRecommendations(body: AIRecommendationRequestDTO) -> Endpoint {
        .post("/api/v1/ai/game-recommendations", body: body, userAuth: true)
    }

    static func aiLibraryCurator(body: LibraryCuratorRequestDTO) -> Endpoint {
        .post("/api/v1/ai/library-curator", body: body, userAuth: true)
    }

    static func aiSearchAssist(body: AISearchAssistRequestDTO) -> Endpoint {
        .post("/api/v1/ai/search-assist", body: body, userAuth: true)
    }
